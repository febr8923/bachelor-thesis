...
for i in "${CPU_THREADS[@]}"; do
  ...
  python run-llm.py --model="$MODEL" --model_location="cpu" --execution_location="cpu" --thread_percentage="$i"
  python run-llm.py --model="$MODEL" --model_location="gpu" --execution_location="cpu" --thread_percentage="$i"
  
  python run-llm.py --model="$MODEL" --model_location="cpu" --cold_start --execution_location="cpu" --thread_percentage="$i"
  python run-llm.py --model="$MODEL" --model_location="gpu" --cold_start --execution_location="cpu" --thread_percentage="$i"
done
...
for ((i=10; i<=100; i+=10)); do
  ...
  python run-llm.py --model="$MODEL" --model_location="gpu" --execution_location="gpu" --thread_percentage="$i"
  python run-llm.py --model="$MODEL" --model_location="cpu" --execution_location="gpu" --thread_percentage="$i"
