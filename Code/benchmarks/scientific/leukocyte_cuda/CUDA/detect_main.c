...
// External timing variables from kernel files (in ms)
extern float g_gicov_transfer_time;
extern float g_gicov_compute_time;
extern float g_dilate_compute_time;
extern float g_mgvf_transfer_time;
extern float g_mgvf_compute_time;
